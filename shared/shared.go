...
type AudiobookBase struct {
	...
	//
	// Any of "audiobook".
	Type AudiobookBaseType `json:"type,required"`
	// The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the
	// audiobook.
...
type EpisodeObject struct {
	...
	//
	// Any of "episode".
	Type EpisodeObjectType `json:"type,required"`
	// The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the
	// episode.
	Uri string `json:"uri,required"`
...
type ShowBase struct {
	...
	//
	// Any of "show".
	Type ShowBaseType `json:"type,required"`
	// The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the
	// show.
	Uri string `json:"uri,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
...
type SimplifiedEpisodeObject struct {
	...
	//
	// Any of "episode".
	Type SimplifiedEpisodeObjectType `json:"type,required"`
	// The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the
	// episode.
	Uri string `json:"uri,required"`
	// The language used in the episode, identified by a
