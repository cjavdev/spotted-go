...
// interacting with the spotted API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (SPOTIFY_ACCESS_TOKEN,
// SPOTTED_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("SPOTTED_CUSTOM_HEADERS"); ok {
...
// environment (SPOTIFY_ACCESS_TOKEN, SPOTTED_BASE_URL). The option passed in as
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Artists = NewArtistService(opts...)
	r.Shows = NewShowService(opts...)
	r.Episodes = NewEpisodeService(opts...)
	r.Audiobooks = NewAudiobookService(opts...)
	r.Me = NewMeService(opts...)
	r.Chapters = NewChapterService(opts...)
	r.Tracks = NewTrackService(opts...)
