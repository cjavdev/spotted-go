...
func TestMeEpisodeListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Me.Episodes.List(context.TODO(), spotted.MeEpisodeListParams{
...
func TestMeEpisodeCheck(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Me.Episodes.Check(context.TODO(), spotted.MeEpisodeCheckParams{
...
func TestMeEpisodeRemoveWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
